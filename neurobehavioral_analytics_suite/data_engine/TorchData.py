...
Defines the TorchData class for handling data using PyTorch in the NeuroBehavioral Analytics Suite.
...
from neurobehavioral_analytics_suite.data_engine.BaseData import BaseData
