...
The `analytics` package within the NeuroBehavioral Analytics Suite (NBAS) defines and manages the application and visualization of data transformations. The key components of this package include:
