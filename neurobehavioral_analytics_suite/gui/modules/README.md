...
The `modules` subpackage within the `gui` package defines and manages various modules for the graphical user interface of the NeuroBehavioral Analytics Suite (NBAS). The key component of this subpackage is:

- **OperationModule**: Manages operations and their GUI representation within the NBAS. It handles initialization, starting, stopping, pausing, resuming, and resetting of operations, and updates the GUI accordingly.

### OperationModule
The `OperationModule` class manages operations and their GUI representation within the NBAS. It handles the initialization, starting, stopping, pausing, resuming, and resetting of operations and updates the GUI accordingly.
