...
The `gui` package within the NeuroBehavioral Analytics Suite (NBAS) defines and manages various graphical user interfaces for interacting with the suite. The key components of this package include:
...
### GuiLauncher
The `GuiLauncher` class launches the GUI for the NBAS, setting up various panes for data analysis, visualization, and operation management, and handling navigation between these panes.

### OperationManagerDialog
The `OperationManagerDialog` class manages the dialog for displaying and controlling operations within the NBAS, adding new operation tiles, and handling GUI resizing.
