...
<div>
  <p align="left">
The `operation_manager/operations/persistent` subpackage handles persistent operations within the NBAS.
<br />
<br />
...
The `persistent` subpackage within the `operation_manager/operations` module defines and manages persistent operations in the NeuroBehavioral Analytics Suite (NBAS). The key components of this subpackage include:
