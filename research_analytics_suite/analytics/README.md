...
<div>
  <p align="left">
The 'analytics' package within the Research Analytics Suite (RAS) handles the application and visualization of data transformations within a project.
<br />
<br />
...
The `analytics` package within the Research Analytics Suite (RAS) defines and manages the application and visualization of data transformations. The key components of this package include:

- **AnalyticsCore**: A class to apply a series of transformations to a given data point, including methods for initializing, adding transformations, and applying transformations.
- **display_transformations**: A function to apply a series of transformations to a given dataset and visualize the results using matplotlib.

### AnalyticsCore
The `AnalyticsCore` class is responsible for applying a series of transformations to a given data point. It includes methods for initializing the transformation list, adding a transformation, and applying all transformations to a data point.

### display_transformations
The `display_transformations` function applies a series of transformations to a given dataset and visualizes the results using matplotlib. It handles deep copying of data, applying transformations, and plotting the results.
...
Usage instructions for the Analytics package will be provided at a later date.
