...
<div align="center">
  ...
  <a href="https://github.com/lane-neuro/research-analytics-suite">
    <img src="../assets/images/centered_banner_white_black_text_1800x700.png" alt="RAS" style="max-width: 75%; height: auto;">
  </a>
...
<div>
  <p align="left">
The `gui/modules` subpackage provides specific graphical user interfaces for managing operations within the Research Analytics Suite (RAS).
<br />
<br />
...
The `modules` subpackage within the `gui` package defines and manages various modules for the graphical user interface of the Research Analytics Suite (RAS). The key component of this subpackage is:

- **OperationModule**: Manages operations and their GUI representation within the RAS. It handles initialization, starting, stopping, pausing, resuming, and resetting of operations, and updates the GUI accordingly.

### OperationModule
The `OperationModule` class manages operations and their GUI representation within the RAS. It handles the initialization, starting, stopping, pausing, resuming, and resetting of operations and updates the GUI accordingly.
...
Usage instructions for the GUI Modules subpackage will be provided at a later date.
