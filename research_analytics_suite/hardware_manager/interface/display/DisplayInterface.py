"""
DisplayInterface Module

This module contains the DisplayInterface base class, which defines the interface for display detection.
...
class DisplayInterface(ABC):
    ...
    def detect(self) -> List[Dict[str, str]]:
        ...
        Returns:
            list: Information about detected display interfaces.
        """
    ...
    def _parse_output(self, output: str) -> List[Dict[str, str]]:
        ...
        Returns:
            list: Parsed information about detected display interfaces.
        """
        raise NotImplementedError
